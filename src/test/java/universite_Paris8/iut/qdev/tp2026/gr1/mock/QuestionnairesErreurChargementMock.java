...
/**
 * Mock scénario d'erreur : questionnairesDisponibles lève ErreurChargementQuestionnairesException.
 *
 * Scénario couvert (plan de test §questionnairesDisponibles – cas 3) :
 *   "Cette méthode doit renvoyer une erreur ErreurChargementQuestionnairesException
 *    si une erreur est présente lors de la lecture/chargement de la liste
 *    des questionnaires."
 */
public class QuestionnairesErreurChargementMock implements ISINTServiceQuizz {
    ...
    public ArrayList<QuestionnaireDispoDTO> questionnairesDisponibles()
        ...
        throw new ErreurChargementQuestionnairesException(
                "Erreur lors du chargement de la liste des questionnaires.");
    }
